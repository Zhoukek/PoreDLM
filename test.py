...
# # 文件路径
# file_path = "/mnt/zzbnew/poregpt/models/HF_VQE768C08A001_DNADLLM_V006/basecall/stage2/train/eval_00001_chunks.jsonl.gz"
...
file_path = "/mnt/zzbnew/rnamodel/data/DNA_data/ONT/ONT-R10-HG002-5K/PBA15131/basecall2/PBA15131_e69e6866_e87b1a7f_6/chunks.npy"
file_path = "/mnt/zzbnew/rnamodel/data/DNA_data/ONT/ONT-R10-HG002-5K/PBA15131/basecall2_trank_appleq50/PBA15131_e69e6866_e87b1a7f_6.npy"

# data = np.load(file_path, allow_pickle=True)
data = np.fromfile(file_path, dtype=np.float32)   # 若原数据是 float64，改成 np.float64
