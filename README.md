...
2. bash /mnt/zzbnew/rnamodel/zhoukexuan/PoreDLM/src/poredlm/data/stage2_BERT_Encoder/step02_split_jsol.gz.sh (jsol.gz文件划分，从不同数量，划分为特定长度，比如1000个token，如果已经长度统一了，可以跳过)
