...
PYTHON_SCRIPT="/mnt/zzbnew/rnamodel/shenhaojie/PoreDLM/test/masked_reconstruction_stage1_stage2_v3.py"

# =========================
# 3. Output paths
# =========================
OUTPUT_DIR="/mnt/zzbnew/rnamodel/shenhaojie/PoreDLM/test/output/outputs_masked_bert_v3"
