...
wandb_run_name="S0_HG002_UNMOD-35g_unfreeze_0_32_dlm_lr_0.00001_12_layer"

base_model="/mnt/si002562jbsc/rnamodel/zhoukexuan/PoreDLM/src/poredlm/training/stage3_OLMo_DLM/runs/02_150m_no_cond_8k_vq/hf_dlm"
...
outdir="/mnt/si002562jbsc/rnamodel/zhoukexuan/PoreDLM/src/poredlm/training/stage4_finetune/runs/S0_HG002_UNMOD-35g_unfreeze_0_32_dlm_lr_0.00001_12_layer"

mkdir -p "${outdir}"

nohup torchrun --nproc_per_node="${nproc_per_node}" --nnodes=1 --master_port 29513 \
