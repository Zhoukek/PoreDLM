...
wandb_run_name="S0_HG002_UNMOD-35g_unfreeze_0_32_dlm_test_mx"
...
outdir="/mnt/si002562jbsc/rnamodel/zhoukexuan/PoreDLM/src/poredlm/training/stage4_finetune/runs/S0_HG002_UNMOD-35g_unfreeze_0_32_dlm_test_mx"

mkdir -p "${outdir}"

nohup torchrun --nproc_per_node="${nproc_per_node}" --nnodes=1 --master_port 29514 \
