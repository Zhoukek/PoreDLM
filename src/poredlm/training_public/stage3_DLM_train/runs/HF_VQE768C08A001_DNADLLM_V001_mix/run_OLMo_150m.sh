...
RUN_ROOT=${PROJECT_ROOT}/src/poredlm/training_public/stage3_DLM_train/runs/HF_VQE768C08A001_DNADLLM_V001_mix
...
nohup "$PYTHON" -m torch.distributed.run \
    ...
    --run_name="dlm_ELF_B_64K_apple_mix" \
    --wandb.entity="zhoukek-zhejiang-university" \
    --wandb.project="stage3_dlm_public" \
    --save_folder="/home/shj/data/zhoukexuan/HF_VQE768C08A001_DNADLLM_V001_mix/model" \
    > "${RUN_ROOT}/nohup.out" 2>&1 &