            ...
            with ThreadPoolExecutor(max_workers=self.thread_count) as executor:
                ...
                for f in as_completed(futures):
                    try:
                        ...
                        raise PoreLMCheckpointError(f"Original error:\n{traceback.format_exc()}")
        return fut
        ...
        if isinstance(optim_state_dict["param_groups"][0]["params"][0], int):
            ...
            for group in optim_state_dict["param_groups"]:
                ...
                if group["param_names"] != group["params"]:
                    ...
                    # FQNs when a wrapped model mixes frozen flow-matching parameters
...
class PoreLMCoreCheckpointer(Checkpointer):
    def save_checkpoint(
        self,
        dir: PathOrStr,
        dist_model: nn.Module,
...
def build_sharded_checkpointer(
    ...
    elif name == ShardedCheckpointerType.porelm_core:
        return PoreLMCoreCheckpointer(cfg)
    else:
