...
# 模型参数
backbone_type="dlm"  # auto 可同时识别 DLM 和标准 Hugging Face BERT；也可显式设为 dlm/bert
batch_size=8
num_epochs=500
head_lr="1e-5"
backbone_lr="1e-5"
...
wandb_run_name="test_public_hf_dlm_basecall_300000_chunks_tcn_ctc_crf_V003"

# 输入、模型和输出路径
base_model="/mnt/zzbnew/poregpt/models/HF_VQE768C08A001_DNADLLM_V003/hf_dlm"
data_root="/mnt/zzbnew/poregpt/models/HF_VQE768C08A001_DNADLLM_V003/basecall/DNA_S1_HG00200_MIX_250F701901011_validation_1_to_50_stone/small_eval"
outdir="${stage4_root}/runs/DNA_S1_HG00200_MIX_250F701901011_300000_chunks_V003_for_haojie"
...
feature_norm_args=()
if [[ "${feature_l2_normalize}" == "true" ]]; then
  feature_norm_args+=(--feature_l2_normalize)
fi

nohup /mnt/zzbnew/rnamodel/zhoukexuan/miniconda3/envs/PoreDLM/bin/python \
