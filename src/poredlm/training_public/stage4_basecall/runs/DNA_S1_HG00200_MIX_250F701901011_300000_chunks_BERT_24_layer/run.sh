...
stage2_root="${project_root}/src/poredlm/training_public/stage2_BERT_trian"
...
# 模型参数
backbone_type="auto"  # auto 可同时识别 DLM 和标准 Hugging Face BERT；也可显式设为 dlm/bert
hidden_layer=-1
...
wandb_run_name="test_public_hf_dlm_basecall_300000_chunks_tcn_ctc_context"

# 输入、模型和输出路径
base_model="${stage2_root}/runs/HF_VQE768C08A001_DNADLLM_V001_24_layer/models/latest"
...
outdir="${stage4_root}/runs/DNA_S1_HG00200_MIX_250F701901011_300000_chunks_BERT_24_layer"
