...
wandb_run_name="test_public_hf_dlm_basecall_800000_chunks_tcn_ctc_crf_A100"

# 输入、模型和输出路径
base_model="${stage3_root}/runs/test/hf_dlm"
data_root="/mnt/si002562jbsc/poregpt/models/HF_VQE768C08A001_DNADLLM_V001/basecall/DNA_S1_HG00200_MIX_250F701901011_800000_chunks/basecall_data"
outdir="${stage4_root}/runs/DNA_S1_HG00200_MIX_250F701901011_800000_chunks_A100"
...
nohup torchrun --nproc_per_node="${nproc_per_node}" --nnodes=1 --master_port="${master_port}" \
  ...
  --log_interval 10 \
  --num_workers 8 \
  --resume_ckpt /mnt/si002562jbsc/rnamodel/zhoukexuan/PoreDLM/src/poredlm/training_public/stage4_basecall/runs/DNA_S1_HG00200_MIX_250F701901011_800000_chunks/ckpt_last_epoch_48.pt \
  "${wandb_args[@]}" \
