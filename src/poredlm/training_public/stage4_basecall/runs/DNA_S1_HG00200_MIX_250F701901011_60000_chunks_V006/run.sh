...
wandb_run_name="test_public_hf_dlm_basecall_60000_chunks_tcn_ctc_V006"

# 输入、模型和输出路径
base_model="/mnt/si002562jbsc/poregpt/models/HF_VQE768C08A001_DNADLLM_V006/hf_dlm"
data_root="/mnt/si002562jbsc/poregpt/models/HF_VQE768C08A001_DNADLLM_V006/basecall/basecall_data"
outdir="${stage4_root}/runs/DNA_S1_HG00200_MIX_250F701901011_60000_chunks_V006"
